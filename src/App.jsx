  ...
  return (
    <div className="group rounded-none bg-white dark:bg-black border border-slate-100 dark:border-[#333] hover:border-slate-300 dark:hover:border-[#555] transition-colors flex flex-col h-full overflow-hidden">
      ...
      <div className="p-4 flex-grow flex flex-col">
        <h3 className="text-[15px] font-bold text-slate-900 dark:text-white mb-1.5 transition-colors">
          {proj.title === 'Cala De Oro Beach Resort Management System' ? 'Cala De Oro Beach Resort' : proj.title}
        </h3>
            ...
            <div className="contents md:block min-w-0 md:space-y-3">
              ...
              <section id="projects" className="order-6 md:order-none bg-white dark:bg-black p-6 md:p-8 rounded-none border border-slate-200 dark:border-[#333] transition-colors dark:shadow-none">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                  {projects.filter(p => ['Registrar System [Capstone]', 'Cala De Oro Beach Resort Management System', 'Bagkuning E-Commerce', 'JoyMove App'].includes(p.title)).map((proj, i) => (
